...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvas-1">
    ...
    <div class="offcanvas-body" style="font-family: Poppins, sans-serif;">
        <ul class="nav nav-pills flex-column nav-fill bg-light" id="opcion">
            <li class="nav-item m-1"><a class="nav-link text-start" href="index.html"><i
                    class="far fa-list-alt mx-1"></i><span>Inicio</span></a></li>
            <li class="nav-item m-1"><a class="nav-link text-start" href="buscar.html"><i
                    class="far fa-user-circle mx-1"></i><span>Buscar Usuario</span></a></li>
            <li class="nav-item m-1"><a class="nav-link text-start" href="editar.html">
            ...
            <li class="nav-item m-1"><a class="nav-link active text-start" href="agregar.html">
...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-lg-5 mx-auto">
            <h2 class="text-center mt-4 mb-4 fw-bold" style="font-family: Poppins, sans-serif;">Agregar Nuevo
                Usuario</h2>

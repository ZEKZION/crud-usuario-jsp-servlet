...
<head>
    ...
    <link href="https://cdn.datatables.net/v/bs5/dt-2.0.7/b-3.0.2/b-html5-3.0.2/r-3.0.2/sc-2.4.2/datatables.min.css"
          rel="stylesheet">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvas-1">
    ...
    <div class="offcanvas-body" style="font-family: Poppins, sans-serif;">
        <ul class="nav nav-pills flex-column nav-fill bg-light" id="opcion">
            <li class="nav-item m-1"><a class="nav-link active text-start" href="index.jsp"><i
                    class="far fa-list-alt mx-1"></i><span>Inicio</span></a></li>
            <li class="nav-item m-1"><a class="nav-link text-start" href="buscar.jsp"><i
                    class="far fa-user-circle mx-1"></i><span>Buscar Usuario</span></a></li>
            <li class="nav-item m-1"><a class="nav-link text-start" href="editar.jsp">
                ...
                <span>Editar Usuario</span></a></li>
            <li class="nav-item m-1"><a class="nav-link text-start" href="agregar.jsp">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                     class="bi bi-person-fill mx-1">
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"></path>
                </svg>
                <span>Agregar Usuario</span></a></li>
        </ul>
    </div>
</div>
<div class="container-fluid sticky-top">
    <nav class="navbar navbar-expand bg-white shadow mb-4">
        <div class="container-fluid"><a class="btn btn-link" role="button" id="sidebarToggleTop"
                ...
                class="navbar-brand w-100 d-flex align-items-center justify-content-center" href="dashboard.html"><span
                class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg
                xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                class="bi bi-clipboard-minus-fill">
                            <path d="M6.5 0A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0zm3 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5z"></path>
...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-lg-5 mx-auto">
            <h2 class="text-center mt-4 mb-4 fw-bold" style="font-family: Poppins, sans-serif;">Editar Usuario</h2>
                ...
                <div class="card-body">
                    <form class="row g-3" action="UsuarioServlet">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="idusuario" name="idusuario" value="<%=usuario.getId() %>" readonly enab>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="nombres">Nombres</label>
                            <input class="form-control" type="text" id="nombres" name="nombres" value="<%=usuario.getNombre() %>">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="apellidos">Apellidos</label>
                            <input class="form-control" type="text" id="apellidos" name="apellidos" value="<%=usuario.getApellido()%>">
                        </div>
                        <div class="form-group">
